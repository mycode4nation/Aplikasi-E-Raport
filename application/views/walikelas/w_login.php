...
<head>
    ...
    <title>Login Rapor <?= $jenisRapor; ?></title>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <div class="account-wall">
                    ...
                    <center style="font-weight: bold; font-size: 18px;">WALI KELAS</center>
                    <br>
                    <center style="font-weight: bold; font-size: 18px;"> Rapor <?= $jenisRapor; ?></center>
